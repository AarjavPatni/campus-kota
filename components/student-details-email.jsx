...
export const EmailTemplate = ({ firstName, ...formDetails }) => (
  <div style={{ 
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', color: '#f3f4f6' }}>
          <tbody>
            ...
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600', width: '40%' }}>Room Number</td>
              <td style={{ padding: '12px 0' }}>{formDetails.room_number}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Full Name</td>
              <td style={{ padding: '12px 0' }}>{formDetails.first_name} {formDetails.last_name}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Father's Name</td>
            ...
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Institute</td>
              <td style={{ padding: '12px 0' }}>{formDetails.institute}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Student Mobile</td>
              <td style={{ padding: '12px 0' }}>{formDetails.student_mobile}</td>
            </tr>
            <tr style={{ borderBottom: '1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Parent Mobile</td>
              <td style={{ padding: '12px 0' }}>{formDetails.parent_mobile}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Guardian Mobile</td>
              <td style={{ padding: '12px 0' }}>{formDetails.guardian_mobile}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
            ...
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Security Deposit</td>
              <td style={{ padding: '12px 0' }}>₹{formDetails.security_deposit}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Monthly Rent</td>
              <td style={{ padding: '12px 0' }}>₹{formDetails.monthly_rent}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #1f2937' }}>
              <td style={{ padding: '12px 0', fontWeight: '600' }}>Move-in Date</td>
